...
public class Calculator {
	/*
	 * This class contains the functions that a basic calculator contains from a
	 * given input from another file. The methods in the file can be activated in another
	 * file and without activation, the class essentially does nothing. However, in
	 * it's current state, the class does nothing but return 0 in one method and an empty
	 * string "" in another.
	 */
	...
	public int getTotal() {
		 ...
		 * file that requires it. However, as is, this will only return the integer
		 * value 0.
		 * 
	...
	public String getHistory() {
		 ...
		 * total has been. However, in it's current state, it will always return an
		 * empty string "".
		 * 
